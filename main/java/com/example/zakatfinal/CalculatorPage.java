...
public class CalculatorPage extends AppCompatActivity {
    ...
    public void loadData () {
        goldWeight = sharedPrefGold.getFloat("gWeight", 0.0F);
        goldWeightEditText.setText("" + goldWeight);

        currentValue = sharedPrefValue.getFloat("cValue", 0.0F);
    ...
    public void clearButtonClick (View v) {
        ...
        if(goldWeightEditText.getText().toString().length() == 0) {
            ...
            q1TextView.setText("Total value of gold : RM0");
            q2TextView.setText("Total gold value that is zakat payable : RM0");
            q3TextView.setText("Uruf : 0g");
            q4TextView.setText("Total zakat : RM0");
            keepRadioButton.setChecked(false);
            wearRadioButton.setChecked(false);
